...
function ts(daysFromNow, hour = 16) {
  const d = new Date();
...
const teams = [
  ...
  { id: 124, name: "São Paulo", logo: "https://media.api-sports.io/football/teams/124.png" },
  { id: 118, name: "Bahia", logo: "https://media.api-sports.io/football/teams/118.png" },
  { id: 154, name: "Botafogo", logo: "https://media.api-sports.io/football/teams/154.png" },
  ...
  { id: 120, name: "Grêmio", logo: "https://media.api-sports.io/football/teams/120.png" },
  { id: 130, name: "Santos", logo: "https://media.api-sports.io/football/teams/130.png" },
  { id: 133, name: "Vasco", logo: "https://media.api-sports.io/football/teams/133.png" },
  { id: 125, name: "Fluminense", logo: "https://media.api-sports.io/football/teams/125.png" },
  { id: 152, name: "Fortaleza", logo: "https://media.api-sports.io/football/teams/152.png" },
  { id: 129, name: "Bragantino", logo: "https://media.api-sports.io/football/teams/129.png" },
  { id: 136, name: "Vitória", logo: "https://media.api-sports.io/football/teams/136.png" },
  { id: 144, name: "Atlético-GO", logo: "https://media.api-sports.io/football/teams/144.png" },
  { id: 134, name: "Athletico-PR", logo: "https://media.api-sports.io/football/teams/134.png" },
  { id: 140, name: "Ceará", logo: "https://media.api-sports.io/football/teams/140.png" },
  { id: 126, name: "Juventude", logo: "https://media.api-sports.io/football/teams/126.png" },
];

function fixture(id, home, away, status, goals, timestamp, round) {
  return {
    fixture: {
      id,
      timestamp,
    ...
    league: {
      standings: [
        teams.map((t, i) => ({
          ...
          all: {
            played: 14,
            win: Math.max(0, 10 - Math.floor(i / 2)),
            draw: 2,
